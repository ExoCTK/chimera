...
Tirr=1200. #terminator **isothermal** temperature--if full redistribution this is equilibrium temp
...
RayAmp=0. #log Rayleigh Haze Amplitude (relative to H2)
